...
(1, "Moonboots", "rabbit", "im so cute", 1),
(2, "Mable", "rabbit", "im so fancy", 1),
(3, "Curtain","object", "i have no feelings", 1),
(4, "Slipper", "object", "i have no thoughts", 1),
(5, "Amos", "human", "im super cool", 2),
(6, "Elliot", "human", "im actually cooler", 2),
(7, "Dan", "human", "nah nah nah", 2),
(8, "Paige", "human", "ooh shiny", 2);